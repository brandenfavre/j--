    ...
    public TokenInfo getNextToken() {
        ...
        switch (ch) {
            ...
            case '9':
                ...
                if (ch == '.') { // DIGITS "." [DIGITS] [EXPONENT] [SUFFIX]
                    buffer.append(ch);
                    nextCh();
                    while(isDigit(ch)){ // [DIGITS]
                        buffer.append(ch);
                ...
                if (ch == 'e' || ch == 'E') { // DIGITS EXPONENT [SUFFIX]
                    buffer.append(ch);
                    nextCh();
                    if (ch == '+' || ch == '-') { // [("+" | "-")]
                        buffer.append(ch);
                ...
                if (ch == 'd' || ch == 'D') { // DIGITS [EXPONENT] SUFFIX
                    buffer.append(ch);
                    nextCh();
                    return new TokenInfo(DOUBLE_LITERAL, buffer.toString(), line);
                } else {
