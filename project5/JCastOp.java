...
class Conversions {
    ...
    public Conversions() {
        ...
        put(Type.CHAR, Type.LONG, new I2L()); // Can directly convert char to int and then to long using I2L
        put(Type.CHAR, Type.DOUBLE, new I2D()); // Same for I2D
...
class L2C implements Converter {
     ...
     */
    public void codegen(CLEmitter output) {
        output.addNoArgInstruction(L2I); // Convert to int first
        output.addNoArgInstruction(I2C);
    }
}
...
class D2C implements Converter {
     ...
     */
    public void codegen(CLEmitter output) {
        output.addNoArgInstruction(D2I); // Convert to int first
        output.addNoArgInstruction(I2C);
    }
}
